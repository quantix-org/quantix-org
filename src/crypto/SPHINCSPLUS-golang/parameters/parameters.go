...
import (
	...
	"github.com/quantix-org/quantix-org/src/crypto/SPHINCSPLUS-golang/tweakable"
)
...
// QUANTIXHASH-robust and N = 32
func MakeSphincsPlusQUANTIXHASH256fRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(32, 16, 68, 17, 35, 9, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH256sRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(32, 16, 64, 8, 22, 14, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH256fSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(32, 16, 68, 17, 35, 9, "QUANTIXHASH-simple", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH256sSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(32, 16, 64, 8, 22, 14, "QUANTIXHASH-simple", RANDOMIZE)
}

// QUANTIXHASH-robust and N = 24
func MakeSphincsPlusQUANTIXHASH192fRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(24, 16, 66, 22, 33, 8, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH192sRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(24, 16, 63, 7, 17, 14, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH192fSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(24, 16, 66, 22, 33, 8, "QUANTIXHASH-simple", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH192sSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(24, 16, 63, 7, 17, 14, "QUANTIXHASH-simple", RANDOMIZE)
}

// QUANTIXHASH-robust and N = 16
func MakeSphincsPlusQUANTIXHASH128fRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(16, 16, 66, 22, 33, 6, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH128sRobust(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(16, 16, 63, 7, 14, 12, "QUANTIXHASH-robust", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH128fSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(16, 16, 66, 22, 33, 6, "QUANTIXHASH-simple", RANDOMIZE)
}
func MakeSphincsPlusQUANTIXHASH128sSimple(RANDOMIZE bool) *Parameters {
	return MakeSphincsPlus(16, 16, 63, 7, 14, 12, "QUANTIXHASH-simple", RANDOMIZE)
}
